            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    <ul class="navbar-nav mr-3">
                        <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg"><em
                                    class="fas fa-bars"></em></a></li>
                        <li><a href="#" data-toggle="search" class="nav-link nav-link-lg d-sm-none"><em
                                    class="fas fa-search"></em></a></li>
                    </ul>
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                ...
                                <a href="#" class="search-close"><em class="fas fa-times"></em></a>
                            </div>
                            <div class="search-item">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                            class="nav-link nav-link-lg message-toggle beep"><em class="far fa-envelope"></em></a>
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            ...
                            <div class="dropdown-footer text-center">
                                <a href="#">View All <em class="fas fa-chevron-right"></em></a>
                            </div>
                        </div>
                    </li>
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                            class="nav-link notification-toggle nav-link-lg beep"><em class="far fa-bell"></em></a>
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="features-profile.html" class="dropdown-item has-icon">
                                <em class="far fa-user"></em> Profile
                            </a>
                            <a href="features-activities.html" class="dropdown-item has-icon">
                                <em class="fas fa-bolt"></em> Activities
                            </a>
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            <a href="#" class="nav-link has-dropdown"><em
                                    class="fas fa-fire"></em><span>Dashboard</span></a>
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><em
                                    class="fas fa-columns"></em> <span>Layout</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li><a class="nav-link" href="blank.html"><em class="far fa-square"></em> <span>Blank
                                    Page</span></a></li>
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-th"></em>
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-th-large"></em>
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="far fa-file-alt"></em>
                                <span>Forms</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-map-marker-alt"></em>
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-plug"></em>
                                <span>Modules</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="far fa-user"></em>
                                <span>Auth</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-exclamation"></em>
                                <span>Errors</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-bicycle"></em>
                        ...
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><em class="fas fa-ellipsis-h"></em>
                        ...
                        <li><a class="nav-link" href="credits.html"><em class="fas fa-pencil-ruler"></em>
                                <span>Credits</span></a></li>
                    </ul>

                    <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                        <a href="https://getstisla.com/docs" class="btn btn-primary btn-lg btn-block btn-icon-split">
                            <em class="fas fa-rocket"></em> Documentation
                        </a>
                    </div>
                </aside>
            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="statistic-details mt-sm-4">
                                        <div class="statistic-details-item">
                                            <span class="text-muted"><span class="text-primary"><em
                                                        class="fas fa-caret-up"></em></span> 7%</span>
                                            <div class="detail-value">$243</div>
                                            <div class="detail-name">Today's Sales</div>
                                        </div>
                                        <div class="statistic-details-item">
                                            <span class="text-muted"><span class="text-danger"><em
                                                        class="fas fa-caret-down"></em></span> 23%</span>
                                            <div class="detail-value">$2,902</div>
                                            <div class="detail-name">This Week's Sales</div>
                                        </div>
                                        <div class="statistic-details-item">
                                            <span class="text-muted"><span class="text-primary"><em
                                                        class="fas fa-caret-up"></em></span>9%</span>
                                            <div class="detail-value">$12,821</div>
                                            <div class="detail-name">This Month's Sales</div>
                                        </div>
                                        <div class="statistic-details-item">
                                            <span class="text-muted"><span class="text-primary"><em
                                                        class="fas fa-caret-up"></em></span> 19%</span>
                                    ...
                                    <div class="row pb-2">
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                ...
                                                <div class="avatar-badge" title="Editor" data-toggle="tooltip"><em
                                                        class="fas fa-wrench"></em></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                ...
                                                <div class="avatar-badge" title="Admin" data-toggle="tooltip"><em
                                                        class="fas fa-cog"></em></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                ...
                                                <div class="avatar-badge" title="Author" data-toggle="tooltip"><em
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col text-center">
                                            ...
                                            <div class="text-muted text-small"><span class="text-primary"><em
                                                        class="fas fa-caret-up"></em></span> 48%</div>
                                        </div>
                                        <div class="col text-center">
                                            <div class="browser browser-firefox"></div>
                                            <div class="mt-2 font-weight-bold">Firefox</div>
                                            <div class="text-muted text-small"><span class="text-primary"><em
                                                        class="fas fa-caret-up"></em></span> 26%</div>
                                        </div>
                                        <div class="col text-center">
                                            <div class="browser browser-safari"></div>
                                            <div class="mt-2 font-weight-bold">Safari</div>
                                            <div class="text-muted text-small"><span class="text-danger"><em
                                                        class="fas fa-caret-down"></em></span> 14%</div>
                                        </div>
                                        <div class="col text-center">
                                        ...
                                        <div class="col text-center">
                                            ...
                                            <div class="text-muted text-small"><span class="text-primary"><em
                                                        class="fas fa-caret-up"></em></span> 5%</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-header-action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item has-icon"><em
                                                        class="far fa-circle"></em> Electronic</a>
                                                <a href="#" class="dropdown-item has-icon"><em
                                                        class="far fa-circle"></em> T-shirt</a>
                                                <a href="#" class="dropdown-item has-icon"><em
                                                        class="far fa-circle"></em> Hat</a>
                                                <div class="dropdown-divider"></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-danger btn-action" data-toggle="tooltip"
                                                            ...
                                                            data-confirm-yes="alert('Deleted')"><em
